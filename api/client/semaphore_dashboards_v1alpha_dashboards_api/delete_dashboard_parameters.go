...
// WithIDOrName adds the iDOrName to the delete dashboard params
func (o *DeleteDashboardParams) WithIDOrName(iDOrName string) *DeleteDashboardParams {
	o.SetIDOrName(iDOrName)
	return o
}

// SetIDOrName adds the idOrName to the delete dashboard params
func (o *DeleteDashboardParams) SetIDOrName(iDOrName string) {
	o.IDOrName = iDOrName
}
