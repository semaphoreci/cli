...
func (o *UpdateSecretParams) WithBody(body *models.SemaphoreSecretsV1betaSecret) *UpdateSecretParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update secret params
func (o *UpdateSecretParams) SetBody(body *models.SemaphoreSecretsV1betaSecret) {
	o.Body = body
}

// WithSecretIDOrName adds the secretIDOrName to the update secret params
func (o *UpdateSecretParams) WithSecretIDOrName(secretIDOrName string) *UpdateSecretParams {
	o.SetSecretIDOrName(secretIDOrName)
	return o
}

// SetSecretIDOrName adds the secretIdOrName to the update secret params
func (o *UpdateSecretParams) SetSecretIDOrName(secretIDOrName string) {
