...
// WithSecretIDOrName adds the secretIDOrName to the delete secret params
func (o *DeleteSecretParams) WithSecretIDOrName(secretIDOrName string) *DeleteSecretParams {
	o.SetSecretIDOrName(secretIDOrName)
	return o
}

// SetSecretIDOrName adds the secretIdOrName to the delete secret params
func (o *DeleteSecretParams) SetSecretIDOrName(secretIDOrName string) {
