...
func TestRunInit__NoParams(t *testing.T) {
	...
	expected := `{"apiVersion":"v1alpha","kind":"Project","metadata":{"name":"something"},"spec":{"repository":{"url":"git@github.com:/renderedtext/something.git","forked_pull_requests":{}}}}`
...
func TestRunInit__NameParamPassed(t *testing.T) {
	...
	expected := `{"apiVersion":"v1alpha","kind":"Project","metadata":{"name":"another-name"},"spec":{"repository":{"url":"git@github.com:/renderedtext/something.git","forked_pull_requests":{}}}}`
...
func TestRunInit__RepoUrlParamPassed(t *testing.T) {
	...
	expected := `{"apiVersion":"v1alpha","kind":"Project","metadata":{"name":"a"},"spec":{"repository":{"url":"git@github.com:/renderedtext/a.git","forked_pull_requests":{}}}}`
