...
func NewCreateCmd() *cobra.Command {
	...
	cmd.Use = "deployment_targets [NAME]"
	cmd.Short = "Create a deployment target."
	cmd.Long = ``
	cmd.Aliases = []string{"targets, deployment_target, target, tgt"}
	...
	cmd.Flags().String(
		"desc",
		"d",
		"Description of deployment target",
	)

	cmd.Flags().String(
		"url",
		"u",
		"URL of deployment target",
	)
